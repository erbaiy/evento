                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInLeft" data-delay=".5s">Digital Conference For Designers
                                    </h1>
                                    <!-- Hero-btn -->
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <p>There arge many variations ohf passages of sorem gpsum ilable, but the majority have
                                ...
                                many variations ohf passages of sorem gpsum ilable.</p>
                            <p>There arge many variations ohf passages of sorem gpsum ilable, but the majority have
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="front-office/assets/img/gallery/about2.png" alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="front-office/assets/img/gallery/about1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
